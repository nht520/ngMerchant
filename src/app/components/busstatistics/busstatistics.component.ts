...
@Component({
  selector: 'app-busstatistics',
  templateUrl: './busstatistics.component.html',
  styleUrls: ['./busstatistics.component.scss']
})
export class BusstatisticsComponent implements OnInit {
  crumbstitle:any = "统计";
  text:any;
  list: any[] = [];
  timeone:any;
